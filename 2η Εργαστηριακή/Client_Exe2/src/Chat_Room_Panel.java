...
import static com.sun.jmx.trace.Trace.send;
...
public class Chat_Room_Panel extends JFrame implements Serializable, ActionListener {
    ...
    private final JTextArea online_users_area;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (o == refresh) {
            try {
                ...
                new Chat_Room_Panel(i2p_session, user, servers_msg.getlist(), out_Server, in_Server, messagesList);
        ...
        if (o == connect_button) {
            ...
            boolean ok = false;
            if (user.getoption() == 1 && users_to_check.length > 1 || user.getoption() == 2 && users_to_check.length < 0) {
                JOptionPane.showMessageDialog(null,
                        "You have selecte Unicast Chat!",
        ...
        if (o == send_button) {
            ...
            try {
                ...
                if (choosen_users.size() > 1) {
                    ...
                    out_client[0].flush();
                    send_messages_area.setText(" ");
                    System.out.println("The message has been send to ");
                }
            } catch (IOException ex) {
                Logger.getLogger(Chat_Room_Panel.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    void Connect_To_Other_User(ArrayList<User_Profile> choosen_users) throws I2PException, ConnectException, NoRouteToHostException, InterruptedIOException, IOException, ClassNotFoundException {
        ...
        if (want_all_to_chat > 0) {
            ...
            new Chat_Room_Panel(i2p_session, user, Online_users_list, out_Server, in_Server, messagesList);
